...
df_train,df_test,y_train,y_test=train_test_split(dp['text_final'],y,test_size=0.33,random_state=42)
...
print("CNN Accuracy Score with Tdidf Vectorizer -> ",accuracy_score(prediction, Test_Y)*100)

# save the trained cnn model to disk
filename = 'finalized_model_cnn1.sav'
